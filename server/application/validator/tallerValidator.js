  ...
  validatingWorkshopData = () => {
    return [
      ...
      body("modalidad")
        ...
        .isString()
        .withMessage("La modalidad debe ser un string"),
      ...
      body("fechaInicio")
        ...
        .isString()
        .withMessage("La fecha de inicio debe ser un string"),

      body("horario")
        .notEmpty()
        .withMessage("El horario es obligatorio")
        .isString()
        .withMessage("El horario debe ser un string"),

      body("duracion")
        .notEmpty()
        .withMessage("La duración es obligatoria")
        .isString()
        .withMessage("La duración debe ser un string"),

      body("materialesProporcionados")
        .optional()
        .isArray()
        .withMessage("Puedes insertar más de un material")
      ...
      body("documental")
        .optional()
        .isURL()
        .withMessage("La URL del documental no es válida"),
      ...
      body("artesanoId")
        .notEmpty()
        .withMessage("El artesanoId es obligatorio")
        .custom((value) => {
      ...
      body("publico")
        .notEmpty()
        .withMessage("El público es obligatorio")
        .isString()
